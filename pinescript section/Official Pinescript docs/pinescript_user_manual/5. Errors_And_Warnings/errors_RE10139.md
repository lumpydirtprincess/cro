...
## [Memory limits exceeded](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#memory-limits-exceeded)
...
### [Requesting collections and other objects with ​`request.*()`​ calls](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#requesting-collections-and-other-objects-with-request-calls)
...
### [How do I fix this?](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#how-do-i-fix-this)
...
#### [Return IDs on some bars](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#return-ids-on-some-bars)
...
#### [Return calculated results](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#return-calculated-results)
...
### [Other possible error sources and their fixes](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#other-possible-error-sources-and-their-fixes)
...
#### [Minimize ​`request.*()`​ calls](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#minimize-request-calls)
...
#### [Reduce drawing updates for tables](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#reduce-drawing-updates-for-tables)

[Tables](https://www.tradingview.com/pine-script-docs/visuals/tables/) display only their _latest state_ as of the last available bar on the chart. The previous states of a table on historical bars are _not_ visible to script users. Therefore, updating and displaying tables across historical bars is typically _unnecessary_. To use the least memory in table drawings, prevent unneccessary updates by defining logic that creates the [table](https://www.tradingview.com/pine-script-reference/v6/#type_table) object once and then populates it on only the _last bar_.
...
#### [Do not update drawings on historical bars](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#do-not-update-drawings-on-historical-bars)

As with tables, all other [drawing objects](https://www.tradingview.com/pine-script-docs/language/type-system/#drawing-types), such as [lines](https://www.tradingview.com/pine-script-docs/visuals/lines-and-boxes/#lines) and [labels](https://www.tradingview.com/pine-script-docs/visuals/text-and-shapes/#labels), show only their _latest_ states after the script loads on the chart. Users cannot see the visuals update as the script executes across history; users see only the drawing updates that occur on _realtime bars_.
...
#### [Minimize the total drawings stored for a chart](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#minimize-the-total-drawings-stored-for-a-chart)
...
#### [Filter dates in strategies](https://www.tradingview.com/pine-script-docs/errors/RE10139/\#filter-dates-in-strategies)
...
[Previous\\
**CW10003**](https://www.tradingview.com/pine-script-docs/errors/CW10003) [Next\\
