![](../4. Writing_Scripts/writing_style-guide.md)

# [Style guide](../4. Writing_Scripts/writing_style-guide.md#style-guide)

## [Introduction](../4. Writing_Scripts/writing_style-guide.md#introduction)
...
## [Naming Conventions](../4. Writing_Scripts/writing_style-guide.md#naming-conventions)
...
## [Script organization](../4. Writing_Scripts/writing_style-guide.md#script-organization)

The Pine Script® compiler is quite forgiving of the positioning of
specific statements or the version
[compiler annotation](../3. Language/language_script-structure.md#compiler-annotations) in the script. While other arrangements are syntactically
...
### [<license>](../4. Writing_Scripts/writing_style-guide.md#license)
...
### [<version>](../4. Writing_Scripts/writing_style-guide.md#version)

This is the
[compiler annotation](../3. Language/language_script-structure.md#compiler-annotations) defining the version of Pine Script the script will use. If
...
### [<declaration\_statement>](../4. Writing_Scripts/writing_style-guide.md#declaration_statement)
...
### [<import\_statements>](../4. Writing_Scripts/writing_style-guide.md#import_statements)

If your script uses one or more Pine Script
[libraries](../1. Concepts/concepts_libraries.md), your
[import](../../reference manual/keywords/import.md)
statements belong here.

### [<constant\_declarations>](../4. Writing_Scripts/writing_style-guide.md#constant_declarations)
...
### [<inputs>](../4. Writing_Scripts/writing_style-guide.md#inputs)
...
### [<function\_declarations>](../4. Writing_Scripts/writing_style-guide.md#function_declarations)
...
[libraries](../1. Concepts/concepts_libraries.md) can be used to
...
### [<calculations>](../4. Writing_Scripts/writing_style-guide.md#calculations)
...
### [<strategy\_calls>](../4. Writing_Scripts/writing_style-guide.md#strategy_calls)

Strategies are easier to read when strategy calls are grouped in the
same section of the script.

### [<visuals>](../4. Writing_Scripts/writing_style-guide.md#visuals)
...
[Z-index](../2. Visuals/visuals_overview.md#z-index) for more
information on how the relative depth of visuals is determined.

### [<alerts>](../4. Writing_Scripts/writing_style-guide.md#alerts)
...
## [Spacing](../4. Writing_Scripts/writing_style-guide.md#spacing)
...
## [Line wrapping](../4. Writing_Scripts/writing_style-guide.md#line-wrapping)

[Line wrapping](../3. Language/language_script-structure.md#line-wrapping) can make long lines of code easier to read by defining a _single line_ of code across _multiple_ lines in the script. Generally, scripts can wrap lines using any indentation length that is _not_ a multiple of four, because the four-space or tab indentation defines [local blocks](../6. FAQ/faq_programming.md#what-does-scope-mean) in Pine.
...
Line wrapping is also useful when working with long [single-line strings](../1. Concepts/concepts_strings.md#single-line-strings). For example, instead of defining a lengthy string on a single line of code, programmers can split that string into smaller parts and [concatenate](../1. Concepts/concepts_strings.md#concatenation) them using the [+](../../reference manual/operators/+.md) operator to wrap the expression across multiple lines for readability:
...
Similar line-wrapping behaviors apply to [multiline strings](../1. Concepts/concepts_strings.md#multiline-strings), which can span multiple visible lines in the code. All parts of the code between a multiline string’s `"""` or `'''` delimiters, including leading spaces and line breaks, represent _literal text_. Pine treats expressions that use multiline strings as part of a single code line, similar to other types of line-wrapped code. See the [Line wrapping](../3. Language/language_script-structure.md#line-wrapping) section of the [Script structure](../3. Language/language_script-structure.md) page for an example.
...
## [Vertical alignment](../4. Writing_Scripts/writing_style-guide.md#vertical-alignment)
...
## [Explicit typing](../4. Writing_Scripts/writing_style-guide.md#explicit-typing)
...
easier to [debug](../4. Writing_Scripts/writing_debugging.md).

[Next 
**Debugging**](../4. Writing_Scripts/writing_debugging.md)