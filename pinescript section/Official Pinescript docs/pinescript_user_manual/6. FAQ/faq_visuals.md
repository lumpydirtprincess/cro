...
# [Visuals](https://www.tradingview.com/pine-script-docs/faq/visuals/\#visuals)

## [Why can’t I use a plot in an ​`if`​ or ​`for`​ statement?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#why-cant-i-use-a-plot-in-an-if-or-for-statement)
...
## [Can I plot diagonals between two points on the chart?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#can-i-plot-diagonals-between-two-points-on-the-chart)

Scripts can plot diagonal lines between two points on a chart by using plots or line objects.

### [Using plots](https://www.tradingview.com/pine-script-docs/faq/visuals/\#using-plots)
...
### [Using lines](https://www.tradingview.com/pine-script-docs/faq/visuals/\#using-lines)
...
## [How can I plot a line with gaps?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-plot-a-line-with-gaps)
...
## [How do I plot a line using start/stop criteria?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-do-i-plot-a-line-using-startstop-criteria)
...
3. Choose a plotting style. Use [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) for either the `series` or `color` parameter of the [plot()](https://www.tradingview.com/pine-script-reference/v6/#fun_plot) function. See the section [How can I plot a line with gaps?](https://www.tradingview.com/pine-script-docs/faq/visuals/#how-can-i-plot-a-line-with-gaps) above for examples.
...
## [How can I plot a support or trend line?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-plot-a-support-or-trend-line)
...
### [Plotting support and resistance](https://www.tradingview.com/pine-script-docs/faq/visuals/\#plotting-support-and-resistance)
...
### [Plotting trend lines](https://www.tradingview.com/pine-script-docs/faq/visuals/\#plotting-trend-lines)
...
## [How can I use colors in my indicator plots?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-use-colors-in-my-indicator-plots)
...
Without needing to specify hexadecimal or RGB (Red Green Blue) values, programmers can use predefined [color constants](https://www.tradingview.com/pine-script-docs/concepts/colors/#constant-colors), such as [color.red](https://www.tradingview.com/pine-script-reference/v6/#var_color.red). In the Pine Editor, clicking the automatically generated color swatch next to a color constant opens up a color picker; choosing a different color from the picker updates the code that defines the color.

**Custom colors**

For a more personalized appearance, programmers can create custom colors, either by specifying a hexadecimal code, or by using the [color.rgb()](https://www.tradingview.com/pine-script-reference/v6/#fun_color.rgb) function to specify the RGB values. For the hexadecimal and RGB equivalents of the built-in color constants, see the table in the [Constant colors](https://www.tradingview.com/pine-script-docs/concepts/colors/#constant-colors) section.

**Transparency settings**

The [color.new()](https://www.tradingview.com/pine-script-docs/concepts/colors/#colornew) function can create colors with a specific transparency. The `transp` parameter can even take series values, meaning that a single color declaration can provide a color with dynamic transparency.

**Conditional coloring**

Scripts can assign different colors to variables based on logical conditions. Programmers can use [conditional colors](https://www.tradingview.com/pine-script-docs/concepts/colors/#conditional-coloring) to color plots, fills, shapes, drawings, or the chart background differently on different bars.
...
## [How do I make my indicator plot in the main chart pane?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-do-i-make-my-indicator-plot-in-the-main-chart-pane)
...
## [How can I plot vertical lines on a chart?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-plot-vertical-lines-on-a-chart)
...
### [By drawing lines](https://www.tradingview.com/pine-script-docs/faq/visuals/\#by-drawing-lines)
...
### [By plotting histograms](https://www.tradingview.com/pine-script-docs/faq/visuals/\#by-plotting-histograms)
...
### [By coloring the background](https://www.tradingview.com/pine-script-docs/faq/visuals/\#by-coloring-the-background)
...
## [How can I toggle hline() levels on and off?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-toggle-hline-levels-on-and-off)
...
## [How can I draw lines or labels into the future?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-draw-lines-or-labels-into-the-future)
...
### [Using bar\_index](https://www.tradingview.com/pine-script-docs/faq/visuals/\#using-bar_index)
...
### [Using time](https://www.tradingview.com/pine-script-docs/faq/visuals/\#using-time)
...
## [How can I keep only the last n number of drawings?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-keep-only-the-last-n-number-of-drawings)
...
### [Using a ​`*.all`​ array](https://www.tradingview.com/pine-script-docs/faq/visuals/\#using-a-all-array)
...
### [Using an array as a queue](https://www.tradingview.com/pine-script-docs/faq/visuals/\#using-an-array-as-a-queue)
...
## [Is it possible to draw geometric shapes?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#is-it-possible-to-draw-geometric-shapes)
...
### [Drawing with polylines](https://www.tradingview.com/pine-script-docs/faq/visuals/\#drawing-with-polylines)
...
### [Drawing with lines](https://www.tradingview.com/pine-script-docs/faq/visuals/\#drawing-with-lines)
...
## [How can I color the chart’s background on a condition detected on the last bar?](https://www.tradingview.com/pine-script-docs/faq/visuals/\#how-can-i-color-the-charts-background-on-a-condition-detected-on-the-last-bar)
...
To color the entire chart background based on a condition detected on the last bar, one workaround is to use a table sized to the visible area of the chart, and color the background of the cell. See this example in the page on [tables](https://www.tradingview.com/pine-script-docs/concepts/tables/#coloring-the-charts-background).
