...
# [Times, dates, and sessions](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#times-dates-and-sessions)

## [How can I get the time of the first bar in the dataset?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-get-the-time-of-the-first-bar-in-the-dataset)
...
The variable stores the value of the [time](https://www.tradingview.com/pine-script-reference/v6/#fun_time) built-in, which represents the time of the bar open in UNIX format (milliseconds since
00:00:00
...
## [How can I convert a time to a date-time string?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-convert-a-time-to-a-date-time-string)

The built-in function [str.format\_time()](https://www.tradingview.com/pine-script-reference/v6/#fun_str.format_time) translates a UNIX timestamp into a string representation of date and time.
...
To improve readability, we use a custom function, `timeToString()`, which calls [str.format\_time()](https://www.tradingview.com/pine-script-reference/v6/#fun_str.format_time) and applies a consistent format, instead of specifying the format for every function call.
...
## [How can I find out how many days are in the current month?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-find-out-how-many-days-are-in-the-current-month)
...
## [How can I detect the chart’s last day?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-detect-the-charts-last-day)

Scripts can detect the last day on a chart in different ways. However, because the [last\_bar\_time](https://www.tradingview.com/pine-script-reference/v6/#var_last_bar_time)
and [timenow](https://www.tradingview.com/pine-script-reference/v6/#var_timenow) variables constantly update to mirror the time of the newest bar, each subsequent realtime bar is _also_ interpreted as if it is the chart’s last day.

### [Using ​`timeframe.change`​](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#using-timeframechange)

This example script checks for all of these conditions:

- The daily timeframe begins a new day.
- The difference between the time of the last chart bar (retrieved using [last\_bar\_time](https://www.tradingview.com/pine-script-reference/v6/#var_last_bar_time))
...
### [Using ​`timenow`​](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#using-timenow)
...
## [How can I get bar’s trading date on symbols with an overnight session?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-get-bars-trading-date-on-symbols-with-an-overnight-session)
...
In addition, the [time\_tradingday](https://www.tradingview.com/pine-script-reference/v6/#var_time_tradingday) variable returns the timestamp of 00:00
...
- Here, we add `"UTC"` as the time zone for the [dayofmonth()](https://www.tradingview.com/pine-script-reference/v6/#fun_dayofmonth) calculation, because [time\_tradingday](https://www.tradingview.com/pine-script-reference/v6/#var_time_tradingday) always returns the trading day as 00:00
...
## [How can I plot a value starting n months or years back?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-plot-a-value-starting-n-months-or-years-back)
...
## [How can I track highs and lows for a specific timeframe?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-track-highs-and-lows-for-a-specific-timeframe)
...
## [How can I track the highs and lows within a specific session or time of day?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-track-the-highs-and-lows-within-a-specific-session-or-time-of-day)
...
## [How can I make an entire custom session visible?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-make-an-entire-custom-session-visible)
...
## [How can I track highs and lows for periods within a bar?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-track-highs-and-lows-for-periods-within-a-bar)
...
The [request.security()](https://www.tradingview.com/pine-script-reference/v6/#fun_request.security) function evaluates the `hiLoBetweenTime()` function _within the context of the lower timeframe_ to calculate the session’s highs and lows.
...
## [How can I detect a specific date and time?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-detect-a-specific-date-and-time)
...
## [How can I know the date when the highest value was found?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-know-the-date-when-the-highest-value-was-found)
...
## [How can I detect bars opening at a specific hour?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-detect-bars-opening-at-a-specific-hour)
...
## [Can I time the duration of a condition?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#can-i-time-the-duration-of-a-condition)
...
## [How can I identify the nth occurrence of a weekday in the month?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-identify-the-nth-occurrence-of-a-weekday-in-the-month)
...
## [How can I count down the remaining time in a bar?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-count-down-the-remaining-time-in-a-bar)
...
## [How can I get the week of the month?](https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/\#how-can-i-get-the-week-of-the-month)
...
[Previous\\
**Techniques**](https://www.tradingview.com/pine-script-docs/faq/techniques) [Next\\
