...
# [Indicators](https://www.tradingview.com/pine-script-docs/faq/indicators/\#indicators)

## [Can I create an indicator that plots like the built-in Volume or Volume Profile indicators?](https://www.tradingview.com/pine-script-docs/faq/indicators/\#can-i-create-an-indicator-that-plots-like-the-built-in-volume-or-volume-profile-indicators)
...
See also [this FAQ entry](https://www.tradingview.com/pine-script-docs/faq/alerts/#how-can-i-get-custom-alerts-on-many-symbols) for an example script that generates alerts on multiple
symbols.
...
[Previous\\
**Functions**](https://www.tradingview.com/pine-script-docs/faq/functions) [Next\\
