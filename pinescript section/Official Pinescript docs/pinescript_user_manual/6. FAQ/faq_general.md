![](../6. FAQ/faq_general.md)

# [FAQ](../6. FAQ/faq_general.md#faq)

## [Get real OHLC price on a Heikin Ashi chart](../6. FAQ/faq_general.md#get-real-ohlc-price-on-a-heikin-ashi-chart)
...
You may see that variable `c` is a Heikin Ashi _close_ price which is
...
## [Get non-standard OHLC values on a standard chart](../6. FAQ/faq_general.md#get-non-standard-ohlc-values-on-a-standard-chart)
...
## [Plot arrows on the chart](../6. FAQ/faq_general.md#plot-arrows-on-the-chart)
...
![image](../images/Buy_sell_chart1.CyNH3Z6U_ZnXhc1.webp)
...
![image](../images/Buy_sell_chart2.bwHf9rIu_Z2nlGwx.webp)

## [Plot a dynamic horizontal line](../6. FAQ/faq_general.md#plot-a-dynamic-horizontal-line)
...
## [Plot a vertical line on condition](../6. FAQ/faq_general.md#plot-a-vertical-line-on-condition)
...
## [Access the previous value](../6. FAQ/faq_general.md#access-the-previous-value)
...
## [Count bars in a dataset](../6. FAQ/faq_general.md#count-bars-in-a-dataset)
...
## [Enumerate bars in a day](../6. FAQ/faq_general.md#enumerate-bars-in-a-day)
...
## [Find the highest and lowest values for the entire dataset](../6. FAQ/faq_general.md#find-the-highest-and-lowest-values-for-the-entire-dataset)
...
## [Query the last non-na value](../6. FAQ/faq_general.md#query-the-last-non-na-value)
...
[Previous 
**Limitations**](../4. Writing_Scripts/writing_limitations.md) [Next 
**Alerts**](../6. FAQ/faq_alerts.md)