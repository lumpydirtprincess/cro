...
# [Bar plotting](https://www.tradingview.com/pine-script-docs/visuals/bar-plotting/\#bar-plotting)

## [Introduction](https://www.tradingview.com/pine-script-docs/visuals/bar-plotting/\#introduction)
...
[na](https://www.tradingview.com/pine-script-reference/v6/#var_na), no
bar is plotted.

## [Plotting candles with ​`plotcandle()`​](https://www.tradingview.com/pine-script-docs/visuals/bar-plotting/\#plotting-candles-with-plotcandle)
...
- We use a tuple (`[open, high, low, close]`) with [request.security()](https://www.tradingview.com/pine-script-reference/v6/#fun_request%7Bdot%7Dsecurity)
...
## [Plotting bars with ​`plotbar()`​](https://www.tradingview.com/pine-script-docs/visuals/bar-plotting/\#plotting-bars-with-plotbar)
...
[Previous\\
**Bar coloring**](https://www.tradingview.com/pine-script-docs/visuals/bar-coloring) [Next\\
