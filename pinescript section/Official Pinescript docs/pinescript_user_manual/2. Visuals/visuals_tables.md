![](../2. Visuals/visuals_tables.md)

# [Tables](../2. Visuals/visuals_tables.md#tables)

## [Introduction](../2. Visuals/visuals_tables.md#introduction)
...
[if](../../reference manual/keywords/if.md) [barstate.islast](../../reference manual/variables/barstate.islast.md)
block.
...
## [Creating tables](../2. Visuals/visuals_tables.md#creating-tables)
...
[table.set\_position()](../../reference manual/functions/table.set_position.md),
[table.set\_bgcolor()](../../reference manual/functions/table.set_bgcolor.md),
[table.set\_frame\_color()](../../reference manual/functions/table.set_frame_color.md),
[table.set\_frame\_width()](../../reference manual/functions/table.set_frame_width.md),
[table.set\_border\_color()](../../reference manual/functions/table.set_border_color.md)
and
[table.set\_border\_width()](../../reference manual/functions/table.set_border_width.md).

Tables can be deleted using
[table.delete()](../../reference manual/functions/table.delete.md),
and their content can be selectively removed using
[table.clear()](../../reference manual/functions/table.clear.md).
...
setter functions:
[table.cell\_set\_text()](../../reference manual/functions/table.cell_set_text.md),
[table.cell\_set\_width()](../../reference manual/functions/table.cell_set_width.md),
[table.cell\_set\_height()](../../reference manual/functions/table.cell_set_height.md),
[table.cell\_set\_text\_color()](../../reference manual/functions/table.cell_set_text_color.md),
[table.cell\_set\_text\_halign()](../../reference manual/functions/table.cell_set_text_halign.md),
[table.cell\_set\_text\_valign()](../../reference manual/functions/table.cell_set_text_valign.md),
[table.cell\_set\_text\_size()](../../reference manual/functions/table.cell_set_text_size.md),
[table.cell\_set\_text\_formatting()](../../reference manual/functions/table.cell_set_text_formatting.md),
and
[table.cell\_set\_bgcolor()](../../reference manual/functions/table.cell_set_bgcolor.md).
...
### [Placing a single value in a fixed position](../2. Visuals/visuals_tables.md#placing-a-single-value-in-a-fixed-position)
...
![image](../images/Tables-ATR-1.aAFiA0fe_Z2lQuMA.webp)
...
![image](../images/Tables-ATR-2.DwFmCnwy_Z1Qkjvb.webp)
...
- We pass
[format.mintick](../../reference manual/constants/format.mintick.md)
...
### [Coloring the chart’s background](../2. Visuals/visuals_tables.md#coloring-the-charts-background)
...
### [Creating a display panel](../2. Visuals/visuals_tables.md#creating-a-display-panel)
...
![image](../images/Tables-DisplayPanel-1.BUQMSYyF_1AwPdc.webp)
...
### [Displaying a heatmap](../2. Visuals/visuals_tables.md#displaying-a-heatmap)
...
![image](../images/Tables-Heatmap-1.BRQU14P0_1voW5h.webp)
...
## [Tips](../2. Visuals/visuals_tables.md#tips)
...
in [if](../../reference manual/keywords/if.md) [barstate.islast](../../reference manual/variables/barstate.islast.md)
...
[Previous 
**Plots**](../2. Visuals/visuals_plots.md) [Next 
**Text and shapes**](../2. Visuals/visuals_text-and-shapes.md)