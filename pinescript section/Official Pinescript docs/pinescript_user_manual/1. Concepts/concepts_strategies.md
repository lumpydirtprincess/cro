...
# [Strategies](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#strategies)

## [Introduction](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#introduction)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Applying-a-strategy-to-a-chart-1.N4wBY_BO_ZmKDt8.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Applying-a-strategy-to-a-chart-2.DYfs3WKI_lkChb.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Strategy-tester-Overview-1.DOd5fCK__2mez0I.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Strategy-tester-List-of-trades-1.Chdio170_Zr8afm.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Broker-emulator-Bar-magnifier-1.C2Dmuk22_zg5of.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Broker-emulator-Bar-magnifier-2.CU_3NoMF_Z1vRwmn.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Orders-and-entries-1.CX7qCrxg_Z1cvssm.webp)
...
### [Limit orders](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#limit-orders)
...
### [Stop and stop-limit orders](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#stop-and-stop-limit-orders)
...
#### [Reversing positions](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#reversing-positions)
...
#### [Pyramiding](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#pyramiding)
...
### [​`strategy.order()`​](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#strategyorder)
...
#### [Exits for multiple entries](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#exits-for-multiple-entries)
...
### [​`strategy.close()`​ and ​`strategy.close_all()`​](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#strategyclose-and-strategyclose_all)
...
### [​`strategy.cancel()`​ and ​`strategy.cancel_all()`​](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#strategycancel-and-strategycancel_all)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Orders-and-entries-Order-placement-commands-11.C3U1GI3M_Z28Nd0o.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Position-sizing-1.CpMYvl8Y_13SmSV.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Position-sizing-2.BNMrWxCG_2i431e.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Closing-a-market-position-1.CG44yAVx_13Jdst.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Closing-a-market-position-2.tTsJ7OdZ_Z1rqIuX.webp)
...
## [OCA groups](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#oca-groups)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-OCA-groups-Strategy-oca-reduce-2.C2FZumhg_Z2ibyig.webp)
...
### [​`strategy.oca.none`​](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#strategyocanone)
...
## [Currency](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#currency)
...
## [Altering calculation behavior](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#altering-calculation-behavior)
...
### [​`calc_on_every_tick`​](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#calc_on_every_tick)
...
- The script uses a [pyramiding](https://www.tradingview.com/pine-script-docs/concepts/strategies/#pyramiding) value of 20, allowing it to simulate up to 20 entries per position with the [strategy.entry()](https://www.tradingview.com/pine-script-reference/v6/#fun_strategy.entry) command.
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Altering-calculation-behavior-Calc-on-every-tick-1.BX0Fex4v_2leRpG.webp)

The script placed a “Buy” order on _each tick_ where the [close](https://www.tradingview.com/pine-script-reference/v6/#var_close) was at the `highest` value, which happened _more than once_ on each realtime bar. Additionally, the [broker emulator](https://www.tradingview.com/pine-script-docs/concepts/strategies/#broker-emulator) filled each [market order](https://www.tradingview.com/pine-script-docs/concepts/strategies/#market-orders) at the current realtime price rather than strictly at the open of the following chart bar.
...
### [​`calc_on_order_fills`​](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#calc_on_order_fills)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Altering-calculation-behavior-Calc-on-order-fills-2.vGEDeBsL_Z1fwIRu.webp)
...
### [​`process_orders_on_close`​](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#process_orders_on_close)
...
## [Simulating trading costs](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#simulating-trading-costs)
...
### [Commission](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#commission)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Simulating-trading-costs-Commission-1.XUDZaoNR_2uIW0M.webp)
...
The results in the [Strategy Tester](https://www.tradingview.com/pine-script-docs/concepts/strategies/#strategy-tester) show that the strategy had a positive equity growth of 17.61% over the testing range. However, the backtest results do not account for fees the broker/exchange may charge. Let’s see what happens to these results when we include a small commission on every trade in the strategy simulation. In this example, we’ve included `commission_type = strategy.commission.percent` and `commission_value = 1` in the [strategy()](https://www.tradingview.com/pine-script-reference/v6/#fun_strategy) declaration, meaning it will simulate a commission of 1% on all executed orders:

![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Simulating-trading-costs-Commission-2.DAdgHUnC_1PsGCK.webp)
...
### [Slippage and unfilled limits](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#slippage-and-unfilled-limits)
...
## [Risk management](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#risk-management)
...
## [Margin](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#margin)
...
## [Using strategy information in scripts](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#using-strategy-information-in-scripts)
...
### [Individual trade information](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#individual-trade-information)
...
## [Strategy alerts](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#strategy-alerts)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Strategies-Strategy-alerts-1.BxOEoyCe_MY9Qd.webp)
...
## [Notes on testing strategies](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#notes-on-testing-strategies)
...
### [Backtesting and forward testing](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#backtesting-and-forward-testing)
...
### [Lookahead bias](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#lookahead-bias)
...
### [Selection bias](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#selection-bias)
...
### [Overfitting](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#overfitting)
...
### [Order limit](https://www.tradingview.com/pine-script-docs/concepts/strategies/\#order-limit)
...
Trimmed orders do **not** appear in the [Strategy Tester](https://www.tradingview.com/pine-script-docs/concepts/strategies/#strategy-tester). Referencing the trimmed order IDs using `strategy.closedtrades.*` functions returns [na](https://www.tradingview.com/pine-script-reference/v6/#var_na).

The [strategy.closedtrades.first\_index](https://www.tradingview.com/pine-script-reference/v6/#var_strategy.closedtrades.first_index) variable holds the index of the oldest _untrimmed_ trade, which corresponds to the first trade listed in the [List of Trades](https://www.tradingview.com/pine-script-docs/concepts/strategies/#list-of-trades). If the strategy creates less than 9000 orders, there are no trimmed orders, and this variable’s value is 0.

[Previous\\
**Sessions**](https://www.tradingview.com/pine-script-docs/concepts/sessions) [Next\\
