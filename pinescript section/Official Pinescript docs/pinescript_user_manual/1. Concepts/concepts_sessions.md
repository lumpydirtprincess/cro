...
# [Sessions](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#sessions)

## [Introduction](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#introduction)
...
## [Time-based sessions](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#time-based-sessions)
...
### [Creating time-based sessions](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#creating-time-based-sessions)
...
### [Using time-based sessions](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#using-time-based-sessions)
...
- The [time()](https://www.tradingview.com/pine-script-reference/v6/#fun_time) function returns a [UNIX timestamp](https://www.tradingview.com/pine-script-docs/concepts/sessions/@concepts/time/#unix-timestamps) for the _opening time_ of the current bar, or [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) if the bar is not in the specified session.
...
## [Named sessions](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#named-sessions)
...
### [Retrieving named sessions](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#retrieving-named-sessions)
...
### [Creating a session-specific ticker](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#creating-a-session-specific-ticker)
...
For more information about the available `ticker.*()` functions, see the [Custom contexts](https://www.tradingview.com/pine-script-docs/concepts/other-timeframes-and-data/#custom-contexts) section of the [Other timeframes and data](https://www.tradingview.com/pine-script-docs/concepts/other-timeframes-and-data/) page.
...
### [Requesting data from session-specific tickers](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#requesting-data-from-session-specific-tickers)
...
## [Session variables reference](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#session-variables-reference)

Programmers can use several built-in variables for session-related data.

### [Market states](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#market-states)
...
### [First and last bars](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#first-and-last-bars)
...
### [Named session variables](https://www.tradingview.com/pine-script-docs/concepts/sessions/\#named-session-variables)
...
[Previous\\
**Repainting**](https://www.tradingview.com/pine-script-docs/concepts/repainting) [Next\\
