...
# [Strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#strings)

## [Introduction](https://www.tradingview.com/pine-script-docs/concepts/strings/\#introduction)
...
## [Literal strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#literal-strings)

Literal strings are constant “string” values whose character sequences are defined literally in the source code. In Pine Script, programmers can define literal strings using [single-line](https://www.tradingview.com/pine-script-docs/concepts/strings/#single-line-strings) or [multiline](https://www.tradingview.com/pine-script-docs/concepts/strings/#multiline-strings) syntax.

### [Single-line strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#single-line-strings)
...
- The script also uses a single-line literal string to specify the `title` argument of the [indicator()](https://www.tradingview.com/pine-script-reference/v6/#fun_indicator) declaration statement.
...
### [Multiline strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#multiline-strings)
...
Multiline string definitions can include the same characters as those that define the enclosing delimiters (`"""` or `'''`) directly in their character sequences. Unlike a [single-line string](https://www.tradingview.com/pine-script-docs/concepts/strings/#single-line-strings) definition, which must prefix the `"` or `'` character with a backslash (`\`) to include it literally if it matches the enclosing characters, a multiline string definition does _not_ require a backslash to include the `"` or `'` character if:
...
## [Escape sequences](https://www.tradingview.com/pine-script-docs/concepts/strings/\#escape-sequences)
...
## [Concatenation](https://www.tradingview.com/pine-script-docs/concepts/strings/\#concatenation)
...
## [String conversion and formatting](https://www.tradingview.com/pine-script-docs/concepts/strings/\#string-conversion-and-formatting)
...
### [Converting values to strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#converting-values-to-strings)
...
### [Formatting strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#formatting-strings)
...
## [Modifying strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#modifying-strings)
...
### [Replacing substrings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#replacing-substrings)
...
### [Changing case](https://www.tradingview.com/pine-script-docs/concepts/strings/\#changing-case)
...
### [Trimming whitespaces](https://www.tradingview.com/pine-script-docs/concepts/strings/\#trimming-whitespaces)
...
### [Repeating sequences](https://www.tradingview.com/pine-script-docs/concepts/strings/\#repeating-sequences)
...
## [String inspection and extraction](https://www.tradingview.com/pine-script-docs/concepts/strings/\#string-inspection-and-extraction)
...
### [Counting characters and substrings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#counting-characters-and-substrings)
...
### [Checking for substrings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#checking-for-substrings)
...
### [Splitting strings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#splitting-strings)
...
### [Locating and retrieving substrings](https://www.tradingview.com/pine-script-docs/concepts/strings/\#locating-and-retrieving-substrings)
...
### [Matching patterns](https://www.tradingview.com/pine-script-docs/concepts/strings/\#matching-patterns)
...
- Because the backslash (`\`) is an [escape character](https://www.tradingview.com/pine-script-docs/concepts/strings/#escape-sequences) in Pine strings, the value used as the `regex` argument in a [str.match()](https://www.tradingview.com/pine-script-reference/v6/#fun_str.match) call requires **two** consecutive backslashes for each single backslash in the regular expression.
...
#### [Regex syntax reference](https://www.tradingview.com/pine-script-docs/concepts/strings/\#regex-syntax-reference)
...
[Previous\\
**Strategies**](https://www.tradingview.com/pine-script-docs/concepts/strategies) [Next\\
