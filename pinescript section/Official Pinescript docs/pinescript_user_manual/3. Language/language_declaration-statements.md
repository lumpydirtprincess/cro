...
# [Declaration statements](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#declaration-statements)

## [Introduction](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#introduction)
...
## [​`indicator()`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#indicator)
...
### [​`title`​ and ​`shorttitle`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#title-and-shorttitle)
...
### [​`overlay`​, ​`scale`​, and ​`behind_chart`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#overlay-scale-and-behind_chart)
...
### [​`format`​ and ​`precision`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#format-and-precision)
...
### [​`max_bars_back`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#max_bars_back)
...
### [​`timeframe`​ and ​`timeframe_gaps`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#timeframe-and-timeframe_gaps)
...
### [​`explicit_plot_zorder`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#explicit_plot_zorder)
...
### [​`max_lines_count`​, ​`max_labels_count`​, ​`max_boxes_count`​, and ​`max_polylines_count`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#max_lines_count-max_labels_count-max_boxes_count-and-max_polylines_count)
...
### [​`calc_bars_count`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#calc_bars_count)
...
### [​`dynamic_requests`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#dynamic_requests)
...
## [​`strategy()`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#strategy)
...
### [​`pyramiding`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#pyramiding)
...
### [​`calc_on_every_tick`​, ​`calc_on_order_fills`​, and ​`process_orders_on_close`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#calc_on_every_tick-calc_on_order_fills-and-process_orders_on_close)
...
### [​`slippage`​ and ​`backtest_fill_limits_assumption`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#slippage-and-backtest_fill_limits_assumption)
...
### [​`default_qty_type`​ and ​`default_qty_value`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#default_qty_type-and-default_qty_value)
...
### [​`initial_capital`​ and ​`currency`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#initial_capital-and-currency)
...
### [​`commission_type`​ and ​`commission_value`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#commission_type-and-commission_value)
...
### [​`close_entries_rule`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#close_entries_rule)
...
### [​`margin_long`​ and ​`margin_short`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#margin_long-and-margin_short)
...
### [​`risk_free_rate`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#risk_free_rate)
...
### [​`use_bar_magnifier`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#use_bar_magnifier)
...
### [​`fill_orders_on_standard_ohlc`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#fill_orders_on_standard_ohlc)
...
## [​`library()`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#library)
...
### [​`title`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#title)
...
### [​`dynamic_requests`​](https://www.tradingview.com/pine-script-docs/language/declaration-statements/\#dynamic_requests-1)
...
[Previous\\
**Identifiers**](https://www.tradingview.com/pine-script-docs/language/identifiers) [Next\\
