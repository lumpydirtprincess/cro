...
# [Built-ins](https://www.tradingview.com/pine-script-docs/language/built-ins/\#built-ins)
...
[ta.tr(true)](https://www.tradingview.com/pine-script-reference/v6/#fun_ta.tr)
...
[time(timeframe)](https://www.tradingview.com/pine-script-reference/v6/#fun_time)
...
session)](https://www.tradingview.com/pine-script-reference/v6/#fun_time)
function returns the time of the bar’s
[open](https://www.tradingview.com/pine-script-reference/v6/#var_open)
from the `timeframe` specified, but only if it is within the
`session` time. The [time(timeframe, session,\\
timezone)](https://www.tradingview.com/pine-script-reference/v6/#fun_time)
function returns the time of the bar’s
[open](https://www.tradingview.com/pine-script-reference/v6/#var_open)
from the `timeframe` specified, but only if it is within the
...
[syminfo.main\_tickerid](https://www.tradingview.com/pine-script-reference/v6/#var_syminfo.main_tickerid),
...
[timeframe.main\_period](https://www.tradingview.com/pine-script-reference/v6/#var_timeframe.main_period),
and
...
[Bar states](https://www.tradingview.com/pine-script-docs/concepts/bar-states/) page):
...
[math.round\_to\_mintick()](https://www.tradingview.com/pine-script-reference/v6/#fun_math.round_to_mintick),
etc.
...
[strategy.closedtrades.entry\_bar\_index()](https://www.tradingview.com/pine-script-reference/v6/#fun_strategy.closedtrades.entry_bar_index),
...
[strategy.closedtrades.max\_drawdown()](https://www.tradingview.com/pine-script-reference/v6/#fun_strategy.closedtrades.max_drawdown),
[strategy.closedtrades.max\_runup()](https://www.tradingview.com/pine-script-reference/v6/#fun_strategy.closedtrades.max_runup),
...
[type system](https://www.tradingview.com/pine-script-docs/language/type-system/). The
...
[Previous\\
**Loops**](https://www.tradingview.com/pine-script-docs/language/loops) [Next\\
