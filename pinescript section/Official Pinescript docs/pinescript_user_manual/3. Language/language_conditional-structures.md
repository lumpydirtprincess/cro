...
# [Conditional structures](https://www.tradingview.com/pine-script-docs/language/conditional-structures/\#conditional-structures)

## [Introduction](https://www.tradingview.com/pine-script-docs/language/conditional-structures/\#introduction)

The conditional structures in Pine Script® are
[if](https://www.tradingview.com/pine-script-reference/v6/#kw_if) and
...
[for](https://www.tradingview.com/pine-script-reference/v6/#kw_for) and
...
An [if](https://www.tradingview.com/pine-script-reference/v6/#kw_if)
...
the [Type system](https://www.tradingview.com/pine-script-docs/language/type-system/#types) page).
...
Using [if](https://www.tradingview.com/pine-script-reference/v6/#kw_if)
...
[declaration mode](https://www.tradingview.com/pine-script-docs/language/variable-declarations/#declaration-modes)
- <type> is optional, as in almost all Pine Script variable
declarations (see [types](https://www.tradingview.com/pine-script-docs/language/type-system/#types))
- <identifier> is the variable’s
[name](https://www.tradingview.com/pine-script-docs/language/identifiers/)
...
<local\_block>, or
[na](https://www.tradingview.com/pine-script-reference/v6/#var_na)
if no local block is executed. If other local blocks return “bool” values, [false](https://www.tradingview.com/pine-script-reference/v6/#const_false) will be returned instead.
...
[na](https://www.tradingview.com/pine-script-reference/v6/#var_na) is
...
### [​`switch`​ with an expression](https://www.tradingview.com/pine-script-docs/language/conditional-structures/\#switch-with-an-expression)
...
“ [input](https://www.tradingview.com/pine-script-docs/language/type-system/#input)” qualifier is). Since it cannot change during the
...
[ta.crossover()](https://www.tradingview.com/pine-script-reference/v6/#fun_ta%7Bdot%7Dcrossover)
and
[ta.crossunder()](https://www.tradingview.com/pine-script-reference/v6/#fun_ta%7Bdot%7Dcrossunder) **prior** to entry in the
[switch](https://www.tradingview.com/pine-script-reference/v6/#kw_switch)
...
[Previous\\
**Operators**](https://www.tradingview.com/pine-script-docs/language/operators) [Next\\
