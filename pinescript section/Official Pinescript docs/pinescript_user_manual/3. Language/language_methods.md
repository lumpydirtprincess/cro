![](../3. Language/language_methods.md)

ADVANCED

# [Methods](../3. Language/language_methods.md#methods)

## [Introduction](../3. Language/language_methods.md#introduction)

Pine Script methods are specialized functions associated with values of specific [built-in types](../3. Language/language_type-system.md#types),
[user-defined types](../3. Language/language_type-system.md#user-defined-types), or [enum types](../3. Language/language_type-system.md#enum-types).
...
of a Pine Script [object](../3. Language/language_objects.md).

## [Built-in methods](../3. Language/language_methods.md#built-in-methods)

Pine Script features built-in methods for most [special types](../3. Language/language_type-system.md#types),
including
...
[chart.point](../../reference manual/types/chart.point.md), [footprint](../../reference manual/types/footprint.md), and [volume\_row](../../reference manual/types/volume_row.md).
...
[get()](../../reference manual/functions/array.get.md)
...
![image](../images/Methods_custom_bb.DR1SlFGg_dfax3.webp)
...
## [User-defined methods](../3. Language/language_methods.md#user-defined-methods)
...
- The
[method](../../reference manual/keywords/method.md)
...
[push()](../../reference manual/functions/array.push.md)
and
[shift()](../../reference manual/functions/array.shift.md)
...
- Just as with user-defined functions, we use the `@function` [compiler annotation](../3. Language/language_script-structure.md#compiler-annotations) to document method descriptions.
...
[avg()](../../reference manual/functions/array.avg.md)
and
[stdev()](../../reference manual/functions/array.stdev.md)
...
## [Method overloading](../3. Language/language_methods.md#method-overloading)
...
[set\_text()](../../reference manual/functions/label.set_text.md)
method:

![image](../images/Methods_overloads_type_inspection.BxAK0zpG_1Y8B6C.webp)
...
## [Advanced example](../3. Language/language_methods.md#advanced-example)
...
[fill()](../../reference manual/functions/array.fill.md)
...
[min()](../../reference manual/functions/array.min.md)
and
[range()](../../reference manual/functions/array.range.md)
...
![image](../images/Methods_empirical_distribution.BdS9hiv6_8zaTc.webp)
...
[Previous 
**Enums**](../3. Language/language_enums.md) [Next 
